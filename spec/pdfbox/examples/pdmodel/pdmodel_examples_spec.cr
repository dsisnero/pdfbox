...
describe "Examples::PDModel parity" do
  ...
  it "TestHelloWorld#testHelloWorldTTF" do
  ...
  it "TestHelloWorld#testHelloWorld" do
    # Java parity expectations:
    # - HelloWorld writes requested output file with provided message
    # - extracted text equals provided message
  end

  it "TestRubberStampWithImage#test" do
    # Java parity expectations:
  ...
  it "TestEmbeddedFiles#testExtractEmbeddedFiles" do
    # Java parity expectations:
  ...
  it "TestCreateSignature#testTimeDifference" do
    # Java parity expectations:
    # - compare local time to NTP (or fallback https Date header)
    # - assert time difference < 15 seconds
  end

  it "TestCreateSignature#testDetachedSHA256 (parameterized externallySign)" do
    # Java parity expectations:
  ...
  it "TestCreateSignature#testDetachedSHA256WithTSA (parameterized externallySign)" do
    # Java parity expectations:
    # - mocked TSA flow signs document and validates timestamp nonce/path behavior
  end

  it "TestCreateSignature#testCreateSignedTimeStamp" do
    # Java parity expectations:
    # - creates standalone signed timestamp and validates token/signature metadata
  end

  it "TestCreateSignature#testCreateVisibleSignature (parameterized externallySign)" do
    # Java parity expectations:
    # - visible signature example writes signed output with expected visible annotation area
  end

  it "TestCreateSignature#testCreateVisibleSignature2 (parameterized externallySign)" do
    # Java parity expectations:
    # - second visible signature implementation signs correctly with expected appearance
  end

  it "TestCreateSignature#testPDFBox3978" do
    # Java parity expectations:
    # - regression scenario signs specific input without corrupting resulting file
  end

  it "TestCreateSignature#testDoubleVisibleSignatureOnEncryptedFile (parameterized externallySign)" do
    # Java parity expectations:
