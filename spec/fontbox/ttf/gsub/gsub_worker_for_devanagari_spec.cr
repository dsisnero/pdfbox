...
module Fontbox::TTF::Gsub
  ...
  private def self.get_glyph_ids(cmap_lookup, word : String) : Array(Int32)
  ...
  describe GsubWorkerForDevanagari do
    it "testApplyTransforms_locl" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "प्त"))
    ...
    it "testApplyTransforms_nukt" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "य़ज़क़"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_akhn" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "क्षज्ञ"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_rphf" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "र्"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_rkrf" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "क्रब्रप्रह्र"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_blwf" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ह्रट्र"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_half" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ह्स्भ्त्"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_vatu" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "श्रत्रस्रघ्र"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_cjct" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "द्मद्ध्र्यब्दद्वद्य"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_pres" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "शृक्तज्जह्ण"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_abvs" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "र्रैंरौंर्रो"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_blws" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "दृहृट्रूट्रु"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_psts" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "किंर्कींरुरू"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_haln" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "द्"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_calt" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, ""))
        result.should eq(glyphs_after_gsub)
      end
    end
  end
