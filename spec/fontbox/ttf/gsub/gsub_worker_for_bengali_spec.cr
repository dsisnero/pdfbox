  ...
  describe GsubWorkerForBengali do
    it "testApplyTransforms_simple_hosshoi_kar" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "আমি"))
    ...
    it "testApplyTransforms_ja_phala" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ব্যাস"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_e_kar" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "বেলা"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_o_kar" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "বোস"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_o_kar_repeated_1_not_working_yet" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ষোলো"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    pending "testApplyTransforms_o_kar_repeated_2_not_working_yet" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ছোটো"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_ou_kar" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "মৌল"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_oi_kar" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "বৈর"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_kha_e_murddhana_swa_e_khiwa" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ক্ষীরের"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_ra_phala" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "দ্রুত"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_ref" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "ধুর্ত"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_ra_e_hosshu" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "রুপো"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_la_e_la_e" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "কল্লোল"))
        result.should eq(glyphs_after_gsub)
      end
    end
    ...
    it "testApplyTransforms_khanda_ta" do
      with_font do |font|
        ...
        result = gsub_worker.apply_transforms(get_glyph_ids(cmap_lookup, "হঠাৎ"))
        result.should eq(glyphs_after_gsub)
      end
    end
  end
